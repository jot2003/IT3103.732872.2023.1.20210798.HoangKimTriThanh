...
public class DayInMonth {
    public static void main(String[] args) {
        ...
        do {
            System.out.print("Hoang Kim Tri Thanh 20210798: Enter a year: ");
            year = scanner.nextInt();
            System.out.print("Hoang Kim Tri Thanh 20210798: Enter a month: ");
            month = scanner.nextInt();

            if (year >= 1 && month >= 1 && month <= 12) {
                stop = true;
            } else {
                System.out.println("Hoang Kim Tri Thanh 20210798: Invalid input. Try again!");
            }
        } while (!stop);

        // Su dung ham de lay so ngay trong thang
        int daysInMonth = getDaysInMonth(year, month);
        System.out.println("Hoang Kim Tri Thanh 20210798: Number of days: " + daysInMonth);
        scanner.close();
    }
